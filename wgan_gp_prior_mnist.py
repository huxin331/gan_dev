...
from model.gan import GanConfig, GanSchema, BaseGan, WGANGP
...
@BaseGan.register('MNIST-WGAN-GP')
class MNIST_WGAN_GP(WGANGP):
...
if __name__ == '__main__':
    ...
    gan_cfg = GanConfig(
        name='MNIST-WGAN-GP', gen_cfg=gen_cfg, dis_cfg=dis_cfg,
        ...
        sampler_cfg=sampler_cfg, dist_loss=False, device=device, LAMBDA=0.1
    )
