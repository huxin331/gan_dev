...
if __name__ == '__main__':
    ...
    gen_cfg = ModelConfig('EDCG', input_size=LATENT_DIM, hidden_size=64, output_size=1, data_num=DATASET_LEN)
    dis_cfg = ModelConfig('DCD', input_size=1, hidden_size=32, output_size=1)
